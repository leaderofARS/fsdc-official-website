...
const FeatureCard = ({ title, desc, icon: Icon, isSmall = false }) => {
  return (
    <div className={`group relative bg-[#0a0a0c] border border-white/5 rounded-2xl p-8 transition-all duration-300 hover:border-purple-500/30 hover:bg-[#0d0d11] ${isSmall ? 'min-h-[200px]' : 'min-h-[250px]'}`}>
